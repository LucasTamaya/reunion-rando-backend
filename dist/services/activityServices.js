...
export const getAllProviderActivities = async (userId) => {
...
export const hasBeenAlreadySaved = async (activityId, userId) => {
...
export const saveActivity = async (activityId, userId) => {
...
export const getSavedActivities = async (userId) => {
...
export const unsaveActivity = async (activityId, userId) => {
    ...
    const filteredSavedByIds = currentData?.savedByIds.filter((id) => id !== userId);
...
//# sourceMappingURL=activityServices.js.map